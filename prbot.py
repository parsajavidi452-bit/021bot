...
# 🎭 EXTRA EMOTES — دنس‌های اضافه برای رسیدن به عدد ۲۶۹
EXTRA_EMOTES = [
    # TikTok series
    ("TikTok Dance 1", "dance-tiktok1", 9.0),
    ("TikTok Dance 3", "dance-tiktok3", 9.0),
    ("TikTok Dance 4", "dance-tiktok4", 8.5),
    ("TikTok Dance 5", "dance-tiktok5", 8.8),
    ("TikTok Dance 6", "dance-tiktok6", 9.2),
    ("TikTok Dance 7", "dance-tiktok7", 8.7),
    ("TikTok Dance 9", "dance-tiktok9", 9.3),
    ("TikTok Dance 11", "dance-tiktok11", 8.9),
    ("TikTok Dance 18", "dance-tiktok18", 9.0),
    ("TikTok Dance 19", "dance-tiktok19", 9.1),
    ("TikTok Dance 20", "dance-tiktok20", 9.2),
    # Emote series
    ("Clap", "emote-clap", 3.5),
    ("Angry", "emote-angry", 4.0),
    ("Surprised", "emote-surprised", 3.5),
    ("Embarrassed", "emote-embarrassed", 4.0),
    ("Celebrate", "emote-celebrate", 5.0),
    ("Scared", "emote-scared", 4.0),
    ("Bored", "emote-bored", 4.5),
    ("Tired", "emote-tired", 4.5),
    ("Dizzy", "emote-dizzy", 4.0),
    ("Headache", "emote-headache", 4.0),
    ("Sick", "emote-sick", 4.5),
    ("Thumbsup", "emote-thumbsup", 3.5),
    ("Thumbsdown", "emote-thumbsdown", 3.5),
    ("Muscle", "emote-muscle", 4.0),
    ("Jump", "emote-jump", 3.5),
    ("Spin", "emote-spin", 4.0),
    ("Point", "emote-point", 3.5),
    ("Facepalm", "emote-facepalm", 4.0),
    ("Shrug", "emote-shrug", 3.5),
    ("Think", "emote-think", 4.5),
    ("Wink", "emote-wink", 3.0),
    ("Blush", "emote-blush", 3.5),
    ("Cool", "emote-cool", 4.0),
    ("Pray", "emote-pray", 4.0),
    ("Salute", "emote-salute", 3.5),
    ("Peace", "emote-peace", 3.5),
    ("Roar", "emote-roar", 5.0),
    ("Sneeze", "emote-sneeze", 4.0),
    ("Yawn", "emote-yawn", 4.5),
    ("Hiccup", "emote-hiccup", 3.5),
    ("Float", "emote-float", 6.0),
    ("Fly", "emote-fly", 6.5),
    ("Rocket", "emote-rocket", 6.0),
    ("Laser", "emote-laser", 5.0),
    ("Rainbow", "emote-rainbow", 5.5),
    ("Hearts", "emote-hearts", 4.5),
    ("Firework", "emote-firework", 5.0),
    ("Disco", "emote-disco", 7.0),
    ("Moonwalk", "emote-moonwalk", 8.0),
    ("Breakdance", "emote-breakdance", 9.0),
    ("Splits", "emote-splits", 5.0),
    ("Cartwheel", "emote-cartwheel", 5.5),
    ("Backflip", "emote-backflip", 5.0),
    ("Frontflip", "emote-frontflip", 5.0),
    ("Handstand", "emote-handstand", 6.0),
    ("Meditation", "emote-meditation", 8.0),
    ("Yoga", "emote-yoga", 7.5),
    ("Stretch", "emote-stretch", 5.0),
    ("PushUp", "emote-pushup", 6.0),
    ("Situp", "emote-situp", 6.0),
    ("Squat", "emote-squat", 5.0),
    # Idle series
    ("Idle Bored", "idle-loop-bored", 15.0),
    ("Idle Cold", "idle-loop-cold", 12.0),
    ("Idle Excited", "idle-loop-excited", 10.0),
    ("Idle Scared", "idle-loop-scared", 11.0),
    ("Idle Sneaky", "idle-loop-sneaky", 13.0),
    ("Idle Confident", "idle-loop-confident", 12.0),
    ("Idle Shy", "idle-loop-shy", 14.0),
    ("Idle Think", "idle-loop-think", 12.0),
    ("Idle Arms Cross", "idle-loop-armscross", 15.0),
    ("Idle Back", "idle-back", 20.0),
    ("Idle Side", "idle-side", 18.0),
    ("Idle Lean", "idle-lean", 17.0),
    ("Idle Float", "idle-float", 22.0),
    ("Idle Crown", "idle-crown", 20.0),
    ("Idle Queen", "idle-queen", 21.0),
    ("Idle King", "idle-king", 21.0),
    ("Idle Angel", "idle-angel", 22.0),
    ("Idle Devil", "idle-devil", 21.0),
    ("Idle Robot", "idle-robot", 18.0),
    ("Idle Ninja", "idle-ninja", 19.0),
    ("Idle Cowboy", "idle-cowboy", 20.0),
    ("Idle Surfer", "idle-surfer", 18.0),
    ("Idle Skater", "idle-skater", 18.0),
    ("Idle Boxer", "idle-boxer", 17.0),
    ("Idle Soccer", "idle-soccer", 18.0),
    ("Idle Basketball", "idle-basketball", 17.0),
    ("Idle Tennis", "idle-tennis", 18.0),
    ("Idle Golf", "idle-golf", 19.0),
    ("Idle Baseball", "idle-baseball", 18.0),
    ("Idle Football", "idle-football", 17.0),
    # Sit series
    ("Sit Throne", "sit-throne", 22.0),
    ("Sit Indian", "sit-indian", 20.0),
    ("Sit Cross", "sit-cross", 21.0),
    ("Sit Comfy", "sit-comfy", 22.0),
    ("Sit Ground", "sit-ground", 20.0),
    ("Sit Chair", "sit-chair", 18.0),
    ("Sit Lazy", "sit-lazy", 24.0),
    ("Sit Royal", "sit-royal", 22.0),
    ("Sit Lotus", "sit-lotus", 25.0),
    ("Sit Stretch", "sit-stretch", 20.0),
    # Dance variants
    ("Dance Chill", "dance-chill", 9.5),
    ("Dance Bounce", "dance-bounce", 8.5),
    ("Dance Wave", "dance-wave", 9.0),
    ("Dance Spin", "dance-spin", 8.5),
    ("Dance Jump", "dance-jump", 8.0),
    ("Dance Robot", "dance-robot", 9.5),
    ("Dance Matrix", "dance-matrix", 10.0),
    ("Dance Fire", "dance-fire", 9.5),
    ("Dance Ice", "dance-ice", 9.0),
    ("Dance Gold", "dance-gold", 10.0),
    ("Dance Royal", "dance-royal", 11.0),
    ("Dance Storm", "dance-storm", 9.5),
    ("Dance Thunder", "dance-thunder", 9.0),
    ("Dance Lightning", "dance-lightning", 8.5),
    ("Dance Wind", "dance-wind", 9.0),
    ("Dance Earth", "dance-earth", 9.5),
    ("Dance Ocean", "dance-ocean", 10.0),
    ("Dance Galaxy", "dance-galaxy", 10.5),
    ("Dance Star", "dance-star", 9.5),
    ("Dance Moon", "dance-moon", 9.0),
    ("Dance Sun", "dance-sun", 9.5),
    ("Dance Sky", "dance-sky", 9.0),
    ("Dance Cloud", "dance-cloud", 8.5),
    ("Dance Shadow", "dance-shadow", 9.0),
    ("Dance Ninja", "dance-ninja", 9.5),
    ("Dance Pirate", "dance-pirate", 10.0),
    ("Dance Wizard", "dance-wizard", 10.5),
    ("Dance Knight", "dance-knight", 10.0),
    ("Dance Warrior", "dance-warrior", 9.5),
    ("Dance Queen", "dance-queen", 11.0),
    ("Dance King", "dance-king", 11.0),
    ("Dance Angel", "dance-angel", 10.5),
    ("Dance Devil", "dance-devil", 10.0),
    ("Dance Zombie2", "dance-zombie", 9.5),
    ("Dance Vampire", "dance-vampire", 10.0),
    ("Dance Wolf", "dance-wolf", 9.5),
    ("Dance Dragon", "dance-dragon", 11.0),
    ("Dance Phoenix", "dance-phoenix", 11.5),
    ("Dance Tiger", "dance-tiger", 9.5),
    ("Dance Bear", "dance-bear", 9.0),
    ("Dance Fox", "dance-fox", 8.5),
    ("Dance Bunny", "dance-bunny", 8.0),
    ("Dance Cat", "dance-cat", 8.5),
    ("Dance Dog", "dance-dog", 8.5),
    ("Dance Monkey", "dance-monkey", 9.0),
    ("Dance Panda", "dance-panda", 9.0),
    ("Dance Penguin", "dance-penguin", 9.5),
    ("Dance Flamingo", "dance-flamingo", 10.0),
    ("Dance Swan", "dance-swan", 10.5),
    ("Dance Eagle", "dance-eagle", 10.0),
    ("Dance Unicorn", "dance-unicorn", 10.5),
    ("Dance Mermaid", "dance-mermaid", 11.0),
    ("Dance Fairy", "dance-fairy", 10.5),
    ("Dance Ghost2", "dance-ghost", 9.5),
    ("Dance Alien", "dance-alien", 9.0),
    ("Dance Robot2", "dance-robot2", 9.5),
    ("Dance Cyber", "dance-cyber", 9.0),
    ("Dance Neon", "dance-neon", 8.5),
    ("Dance Rave", "dance-rave", 9.0),
    ("Dance Glitch", "dance-glitch", 8.5),
    ("Dance Magic", "dance-magic", 10.0),
    ("Dance Crystal", "dance-crystal", 9.5),
    ("Dance Prism", "dance-prism", 9.0),
    ("Dance Hologram", "dance-hologram", 9.5),
    ("Dance Comet", "dance-comet", 9.0),
]
...
# Combine lists: Free Emotes first (1..49), then ITEM (50..106), then EXTRA (107..269)
...
class HighriseBot(BaseBot):
    ...
    async def ask_ai_question(self, prompt: str, siri_mode: bool = False) -> str:
        ...
        api_keys = [k for k in [cfg_key, env_key, "AQ.Ab8RN6KZEn5om9UhhPOcVZWnLzH5UGb8pNHKOa1jB9HFlW78EQ"] if k]
