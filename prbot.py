...
# ════════════════════════════════════════════════════════════════
# Emotes Data (inline — full dictionary)
# ════════════════════════════════════════════════════════════════
class Emote:
...
emote_dict = {
    "Rest": ['sit-idle-cute', 17.062613, False],
    "Zombie": ['idle_zombie', 28.754937, False],
    "Relaxed": ['sit-relaxed', 29.889858, False],
    "Attentive": ['idle_layingdown', 24.585168, False],
    "Sleepy": ['idle-loop-tired', 21.959007, False],
    "Pouty Face": ['idle-sad', 24.377214, False],
    "Posh": ['idle-posh', 21.851256, False],
    "Tap Loop": ['idle-loop-tapdance', 6.261593, False],
    "Sit": ['idle-loop-sitfloor', 22.321055, True],
    "Shy": ['emote-shy', 4.477567, True],
    "Bummed": ['idle-loop-sad', 6.052999, False],
    "Chillin'": ['idle-loop-happy', 18.798322, False],
    "Annoyed": ['idle-loop-annoyed', 17.058522, False],
    "Aerobics": ['idle-loop-aerobics', 8.507535, False],
    "Ponder": ['idle-lookup', 22.339865, False],
    "Hero Pose": ['idle-hero', 21.877099, False],
    "Relaxing": ['idle-floorsleeping2', 17.253372, False],
    "Cozy Nap": ['idle-floorsleeping', 13.935264, False],
    "Enthused": ['idle-enthusiastic', 15.941537, True],
    "Boogie Swing": ['idle-dance-swinging', 13.198551, False],
    "Feel The Beat": ['idle-dance-headbobbing', 25.367458, False],
    "Irritated": ['idle-angry', 25.427848, False],
    "Yes": ['emote-yes', 2.565001, True],
    "I Believe I Can Fly": ['emote-wings', 13.134487, False],
    "The Wave": ['emote-wave', 2.690873, True],
    "Tired": ['emote-tired', 4.61063, True],
    "Think": ['emote-think', 3.691104, False],
    "Theatrical": ['emote-theatrical', 8.591869, False],
    "Tap Dance": ['emote-tapdance', 11.057294, False],
    "Super Run": ['emote-superrun', 6.273226, False],
    "Super Punch": ['emote-superpunch', 3.751054, False],
    "Sumo Fight": ['emote-sumo', 10.868834, False],
    "Thumb Suck": ['emote-suckthumb', 4.185944, False],
    "Splits Drop": ['emote-splitsdrop', 4.46931, False],
    "Snowball Fight!": ['emote-snowball', 5.230467, True],
    "Snow Angel": ['emote-snowangel', 6.218627, True],
    "Secret Handshake": ['emote-secrethandshake', 3.879024, False],
    "Sad": ['emote-sad', 5.411073, True],
    "Rope Pull": ['emote-ropepull', 8.769656, False],
    "Roll": ['emote-roll', 3.560517, False],
    "ROFL!": ['emote-rofl', 6.314731, False],
    "Robot": ['emote-robot', 7.607362, False],
    "Rainbow": ['emote-rainbow', 2.813373, False],
    "Proposing": ['emote-proposing', 4.27888, False],
    "Peekaboo!": ['emote-peekaboo', 3.629867, False],
    "Peace": ['emote-peace', 5.755004, False],
    "Panic": ['emote-panic', 2.850966, False],
    "No": ['emote-no', 2.703034, True],
    "Ninja Run": ['emote-ninjarun', 4.754721, False],
    "Night Fever": ['emote-nightfever', 5.488424, False],
    "Monster Fail": ['emote-monster_fail', 4.632708, False],
    "Model": ['emote-model', 6.490173, True],
    "Flirty Wave": ['emote-lust', 4.655965, True],
    "Level Up!": ['emote-levelup', 6.0545, False],
    "Amused": ['emote-laughing2', 5.056641, False],
    "Laugh": ['emote-lagughing', 1.125537, False],
    "Kiss": ['emote-kiss', 2.387175, True],
    "Super Kick": ['emote-kicking', 4.867992, False],
    "Jump": ['emote-jumpb', 3.584234, False],
    "Judo Chop": ['emote-judochop', 2.427442, False],
    "Imaginary Jetpack": ['emote-jetpack', 16.759457, False],
    "Hug Yourself": ['emote-hugyourself', 4.992751, False],
    "Sweating": ['emote-hot', 4.353037, True],
    "Hero Entrance": ['emote-hero', 4.996096, False],
    "Hello": ['emote-hello', 2.734844, True],
    "Headball": ['emote-headball', 10.073119, False],
    "Harlem Shake": ['emote-harlemshake', 13.558597, False],
    "Happy": ['emote-happy', 3.483462, False],
    "Handstand": ['emote-handstand', 4.015678, False],
    "Greedy Emote": ['emote-greedy', 4.639828, True],
    "Graceful": ['emote-graceful', 3.7498, False],
    "Moonwalk": ['emote-gordonshuffle', 8.052307, False],
    "Ghost Float": ['emote-ghost-idle', 19.570492, False],
    "Gangnam Style": ['emote-gangnam', 7.275486, False],
    "Frolic": ['emote-frollicking', 3.700665, False],
    "Faint": ['emote-fainting', 18.423499, False],
    "Clumsy": ['emote-fail2', 6.475972, False],
    "Fall": ['emote-fail1', 5.617942, False],
    "Face Palm": ['emote-exasperatedb', 2.722748, True],
    "Exasperated": ['emote-exasperated', 2.367483, False],
    "Elbow Bump": ['emote-elbowbump', 3.799768, False],
    "Disco": ['emote-disco', 5.366973, False],
    "Blast Off": ['emote-disappear', 6.195985, False],
    "Faint Drop": ['emote-deathdrop', 3.762728, False],
    "Collapse": ['emote-death2', 4.855549, False],
    "Revival": ['emote-death', 6.615967, False],
    "Dab": ['emote-dab', 2.717871, False],
    "Curtsy": ['emote-curtsy', 2.425714, True],
    "Confusion": ['emote-confused', 8.578827, True],
    "Cold": ['emote-cold', 3.664348, False],
    "Charging": ['emote-charging', 8.025079, True],
    "Bunny Hop": ['emote-bunnyhop', 12.380685, False],
    "Bow": ['emote-bow', 3.344036, True],
    "Boo": ['emote-boo', 4.501502, False],
    "Home Run!": ['emote-baseball', 7.254841, False],
    "Falling Apart": ['emote-apart', 4.809542, False],
    "Thumbs Up": ['emoji-thumbsup', 2.702369, True],
    "Point": ['emoji-there', 2.059095, False],
    "Sneeze": ['emoji-sneeze', 2.996694, False],
    "Smirk": ['emoji-smirking', 4.823158, False],
    "Sick": ['emoji-sick', 5.070367, False],
    "Gasp": ['emoji-scared', 3.008487, False],
    "Punch": ['emoji-punch', 1.755783, False],
    "Pray": ['emoji-pray', 4.503179, False],
    "Stinky": ['emoji-poop', 4.795735, False],
    "Naughty": ['emoji-naughty', 4.277602, False],
    "Mind Blown": ['emoji-mind-blown', 2.397167, False],
    "Lying": ['emoji-lying', 6.313748, False],
    "Levitate": ['emoji-halo', 5.837754, False],
    "Fireball Lunge": ['emoji-hadoken', 2.723709, False],
    "Give Up": ['emoji-give-up', 5.407888, False],
    "Tummy Ache": ['emoji-gagging', 5.500202, True],
    "Flex": ['emoji-flex', 2.099351, True],
    "Stunned": ['emoji-dizzy', 4.053049, False],
    "Cursing Emote": ['emoji-cursing', 2.382069, True],
    "Sob": ['emoji-crying', 3.696499, False],
    "Clap": ['emoji-clapping', 2.161757, False],
    "Raise The Roof": ['emoji-celebrate', 3.412258, True],
    "Arrogance": ['emoji-arrogance', 6.869441, False],
    "Angry": ['emoji-angry', 5.760023, True],
    "Vogue Hands": ['dance-voguehands', 9.150634, False],
    "Savage Dance": ['dance-tiktok8', 10.938702, True],
    "Don't Start Now": ['dance-tiktok2', 10.392353, True],
    "Yoga Flow": ['dance-spiritual', 15.795092, False],
    "Smoothwalk": ['dance-smoothwalk', 6.690023, False],
    "Ring on It": ['dance-singleladies', 21.191372, False],
    "Let's Go Shopping": ['dance-shoppingcart', 4.316035, True],
    "Russian Dance": ['dance-russian', 10.252905, True],
    "Robotic": ['dance-robotic', 17.814959, False],
    "Penny's Dance": ['dance-pennywise', 1.214349, True],
    "Orange Juice Dance": ['dance-orangejustice', 6.475263, False],
    "Rock Out": ['dance-metal', 15.076377, False],
    "Karate": ['dance-martial-artist', 13.284405, False],
    "Macarena": ['dance-macarena', 12.214141, True],
    "Hands in the Air": ['dance-handsup', 22.283413, False],
    "Floss": ['dance-floss', 21.329661, False],
    "Duck Walk": ['dance-duckwalk', 11.748784, False],
    "Breakdance": ['dance-breakdance', 17.623849, False],
    "K-Pop Dance": ['dance-blackpink', 7.150958, True],
    "Push Ups": ['dance-aerobics', 8.796402, False],
    "Hyped": ['emote-hyped', 7.492423, True],
    "Jinglebell": ['dance-jinglebell', 11, True],
    "Nervous": ['idle-nervous', 21.714221, True],
    "Toilet": ['idle-toilet', 32.174447, True],
    "Attention": ['emote-attention', 4.401206, False],
    "Astronaut": ['emote-astronaut', 13.791175, True],
    "Dance Zombie": ['dance-zombie', 12.922772, True],
    "Ghost": ['emoji-ghost', 3.472759, False],
    "Heart Eyes": ['emote-hearteyes', 4.034386, True],
    "Swordfight": ['emote-swordfight', 5.914365, True],
    "TimeJump": ['emote-timejump', 4.007305, True],
    "Snake": ['emote-snake', 5.262578, True],
    "Heart Fingers": ['emote-heartfingers', 4.001974, True],
    "Heart Shape": ['emote-heartshape', 6.232394, False],
    "Hug": ['emote-hug', 3.503262, False],
    "Eyeroll": ['emoji-eyeroll', 3.020264, False],
    "Embarrassed": ['emote-embarrassed', 7.414283, False],
    "Float": ['emote-float', 8.995302, True],
    "Telekinesis": ['emote-telekinesis', 10.492032, True],
    "Sexy dance": ['dance-sexy', 12.30883, False],
    "Puppet": ['emote-puppet', 16.325823, False],
    "Fighter idle": ['idle-fighter', 17.19123, False],
    "Penguin dance": ['dance-pinguin', 11.58291, True],
    "Creepy puppet": ['dance-creepypuppet', 6.416121, True],
    "Sleigh": ['emote-sleigh', 11.333165, True],
    "Maniac": ['emote-maniac', 4.906886, True],
    "Energy Ball": ['emote-energyball', 7.575354, True],
    "Singing": ['idle_singing', 10.260182, True],
    "Frog": ['emote-frog', 14.55257, True],
    "Superpose": ['emote-superpose', 4.530791, True],
    "Cute": ['emote-cute', 6.170464, True],
    "TikTok Dance 9": ['dance-tiktok9', 11.892918, True],
    "Weird Dance": ['dance-weird', 21.556237, True],
    "TikTok Dance 10": ['dance-tiktok10', 8.225648, True],
    "Pose 7": ['emote-pose7', 4.655283, True],
    "Pose 8": ['emote-pose8', 4.808806, True],
    "Casual Dance": ['idle-dance-casual', 9.079756, True],
    "Pose 1": ['emote-pose1', 2.825795, True],
    "Pose 3": ['emote-pose3', 5.10562, True],
    "Pose 5": ['emote-pose5', 4.621532, True],
    "Cutey": ['emote-cutey', 3.26032, True],
    "Punk Guitar": ['emote-punkguitar', 9.365807, True],
    "Zombie Run": ['emote-zombierun', 9.182984, False],
    "Fashionista": ['emote-fashionista', 5.606485, True],
    "Gravity": ['emote-gravity', 8.955966, True],
    "Ice Cream Dance": ['dance-icecream', 14.769573, True],
    "Wrong Dance": ['dance-wrong', 12.422389, True],
    "UwU": ['idle-uwu', 24.761968, True],
    "TikTok Dance 4": ['idle-dance-tiktok4', 15.500708, True],
    "Advanced Shy": ['emote-shy2', 4.989278, True],
    "Anime Dance": ['dance-anime', 8.46671, True],
    "Kawaii": ['dance-kawai', 10.290789, True],
    "Scritchy": ['idle-wild', 26.422824, True],
    "Ice Skating": ['emote-iceskating', 7.299156, True],
    "SurpriseBig": ['emote-pose6', 5.375124, True],
    "Celebration Step": ['emote-celebrationstep', 3.353703, True],
    "Creepycute": ['emote-creepycute', 7.902453, True],
    "Frustrated": ['emote-frustrated', 5.584622, False],
    "Pose 10": ['emote-pose10', 3.989871, True],
    "Laid Back": ['sit-open', 26.025963, False],
    "Star gazing": ['emote-stargaze', 1.127464, False],
    "Slap": ['emote-slap', 2.724945, False],
    "Boxer": ['emote-boxer', 5.555702, True],
    "Head Blowup": ['emote-headblowup', 11.667537, True],
    "KawaiiGoGo": ['emote-kawaiigogo', 10, False],
    "Repose": ['emote-repose', 1.118455, False],
    "Tiktok7": ['idle-dance-tiktok7', 12.956484, False],
    "Shrink": ['emote-shrink', 8.738784, False],
    "Ditzy Pose": ['emote-pose9', 4.583117, True],
    "Teleporting": ['emote-teleporting', 11.7676, True],
    "Touch": ['dance-touch', 11.7, True],
    "Air Guitar": ['idle-guitar', 13.229398, True],
    "This Is For You": ['emote-gift', 5.8, True],
    "Push it": ['dance-employee', 8, True],
    "Sweet Smooch": ['emote-kissing', 5, False],
    "Wop Dance": ['dance-tiktok11', 11, True],
    "Cute Salute": ['emote-cutesalute', 3, True],
    "At Attention": ['emote-salute', 3, True],
    "Popular Vibe": ['dance-popularvibe', 8.5, True],
    "Groove": ['dance-groove', 9.0, True],
    "Shuffle Dance": ['dance-shuffle', 8.0, True],
    "Samba": ['dance-samba', 10.0, True],
    "Salsa": ['dance-salsa', 9.5, True],
    "Tango": ['dance-tango', 11.0, True],
    "Hip Hop": ['dance-hiphop', 10.5, True],
    "Pop Dance": ['dance-pop', 8.2, True],
    "Rock Dance": ['dance-rock', 9.1, True],
    "K-Pop Style": ['dance-kpop', 7.8, True],
    "Jazz Flow": ['dance-jazz', 10.2, True],
    "Ballet Spin": ['dance-ballet', 12.0, True],
    "Waltz": ['dance-waltz', 11.5, True],
    "Electro Bounce": ['dance-electro', 8.8, True],
    "House Beat": ['dance-house', 9.3, True],
    "Techno Step": ['dance-techno', 8.7, True],
    "Trap Motion": ['dance-trap', 7.9, True],
    "Dubstep": ['dance-dubstep', 9.6, True],
    "Funk Groove": ['dance-funk', 8.4, True],
    "Soul Dance": ['dance-soul', 10.1, True],
    "Reggae Vibe": ['dance-reggae', 9.8, True],
    "Latino Heat": ['dance-latino', 10.3, True],
    "Swing Step": ['dance-swing', 8.9, True],
    "Cha Cha": ['dance-chacha', 9.2, True],
    "Rumba": ['dance-rumba', 11.1, True],
    "Foxtrot": ['dance-foxtrot', 10.7, True],
    "Quickstep": ['dance-quickstep', 8.1, True],
    "Paso Doble": ['dance-pasodoble', 10.4, True],
    "Jive": ['dance-jive', 8.6, True],
    "Mambo": ['dance-mambo', 9.4, True],
    "Bolero": ['dance-bolero', 11.8, True],
    "Country Jig": ['dance-country', 8.3, True],
    "Folk Dance": ['dance-folk', 9.7, True],
    "Bollywood": ['dance-bollywood', 10.6, True],
    "Belly Dance": ['dance-belly', 11.2, True],
    "Break Freeze": ['dance-break', 9.9, True],
    "Popping": ['dance-popping', 8.5, True],
    "Locking": ['dance-locking', 8.7, True],
    "Krump": ['dance-krump', 7.6, True],
    "Tutting": ['dance-tutting', 9.1, True],
    "Voguing": ['dance-voguing', 9.3, True],
    "Waacking": ['dance-waacking', 8.8, True],
    "Dancehall": ['dance-dancehall', 10.0, True],
    "Afrobeat": ['dance-afro', 9.5, True],
    "Shuffle Pro": ['dance-shuffle2', 8.2, True],
    "TikTok Dance 12": ['dance-tiktok12', 9.0, True],
    "TikTok Dance 13": ['dance-tiktok13', 8.6, True],
    "TikTok Dance 14": ['dance-tiktok14', 9.2, True],
    "TikTok Dance 15": ['dance-tiktok15', 8.8, True],
    "TikTok Dance 16": ['dance-tiktok16', 9.4, True],
    "TikTok Dance 17": ['dance-tiktok17', 9.1, True],
}

emotes = [Emote(name=name, id=data[0], duration=data[1], is_free=data[2]) for name, data in emote_dict.items()]

# ════════════════════════════════════════════════════════════════
# Keep Alive Flask Server + Auto Self-Ping for Render Free Tier
# ════════════════════════════════════════════════════════════════
app = Flask(__name__)
...
<head>
    <meta charset="UTF-8">
    <title>Highrise Bot — Theme Park Pro (prbot.py) 🤖🎡</title>
    <style>
        body { font-family: Tahoma, sans-serif; background: #0f172a; color: #f8fafc; text-align: center; padding: 40px; }
        .card { background: #1e293b; padding: 30px; border-radius: 16px; display: inline-block; box-shadow: 0 10px 25px rgba(0,0,0,0.5); max-width: 600px; }
        h1 { color: #38bdf8; margin-bottom: 10px; }
        .badge { background: #22c55e; color: #fff; padding: 6px 14px; border-radius: 20px; font-weight: bold; }
        .info { margin-top: 20px; font-size: 16px; color: #cbd5e1; line-height: 1.8; }
    </style>
</head>
<body>
    <div class="card">
        <h1>🤖 Highrise Theme Park Bot is Active (prbot.py)</h1>
        <p><span class="badge">وضعیت: آنلاین 🟢</span></p>
        <div class="info">
            <p>🎡 شهربازی فعال با تمام بازی‌های چرخ‌فلک، ترن، صندلی بازی و ماشین برقی!</p>
            <p>📌 موقعیت بات و اسپم‌ها پایدار شده و هنگام ری‌استارت رندر خودکار برمی‌گردند.</p>
            <p>⏰ Uptime: {{ uptime }}</p>
        </div>
    </div>
</body>
...
class HighriseBot(BaseBot):
    ...
    # 🤖 AI Assistant Engine
    async def ask_ai_question(self, prompt: str) -> str:
        import urllib.request, json, asyncio, os
        user_key = "AQ.Ab8RN6K2ir7M4Ayvykq21-IrRetyTNlJSdxrGNljzwN2v8rFwA"
        env_key = os.environ.get("GEMINI_API_KEY", "")
        api_keys = [user_key, env_key]
        ...
        for key in api_keys:
            ...
            for model in models:
                ...
                payload = {
                    "contents": [{
                        "parts": [{"text": f"شما دستیار هوشمند و بات اختصاصی هایرایز (prbot) هستید. بسیار کوتاه و صمیمی به زبان فارسی پاسخ دهید:\n{prompt}"}]
                    }]
                }
                try:
                    ...
                    pass
        return "سلام! من هوش مصنوعی بات هایرایز هستم. در حال حاضر ترافیک بالاست، لطفا چند ثانیه دیگه دوباره سوالت رو بپرس! 🤖✨"
    ...
    async def on_whisper(self, user: User, message: str) -> None:
        try:
            ...
            # Dance by number 1-269
            if msg.isdigit():
                num = int(msg)
                if 1 <= num <= len(self.emotes):
                    e = self.emotes[num - 1]
                    await self.start_user_dance(user_id, e.id)
                    await self.highrise.send_whisper(user_id, f"🎭 دنس شماره {num} ({e.name}) برای شما اجرا شد! ✨")
                else:
                    await self.highrise.send_whisper(user_id, f"⚠️ شماره دنس باید بین ۱ تا {len(self.emotes)} باشد.")
                return

            # Dance by Link / Item ID
            if "high.rs" in msg_low or "item?id=" in msg_low or "dance-" in msg_low or "emote-" in msg_low or msg_low.startswith("pr ") or msg_low.startswith("!dance"):
                match_id = re.search(r'id=([a-zA-Z0-9_\-]+)', msg)
                if match_id:
                    emote_id = match_id.group(1)
                else:
                    match_dance = re.search(r'((?:dance|emote|idle)-[a-zA-Z0-9_\-]+)', msg)
                    if match_dance:
                        emote_id = match_dance.group(1)
                    else:
                        parts = msg.split(" ", 1)
                        emote_id = parts[1].strip() if len(parts) > 1 else ""

                if emote_id:
                    await self.start_user_dance(user_id, emote_id)
                    await self.highrise.send_whisper(user_id, f"🎵 دنس «{emote_id}» برای شما اجرا شد! 🎭")
                    return
...
# 👑 ADMIN MANAGEMENT COMMANDS (!addadmin, !remadmin, !admins)
            ...
            if msg_low in ["!balance", "!موجودی"]:
                ...
                return
                        ...
                        # 🎵 Link Dance Handler & Custom Emote Links (e.g. https://high.rs/item?id=dance-popularvibe&type=emote)
            if "high.rs" in msg_low or "item?id=" in msg_low or "dance-" in msg_low or "emote-" in msg_low or msg_low.startswith("pr ") or msg_low.startswith("!dance"):
                match_id = re.search(r"id=([a-zA-Z0-9_\-]+)", msg)
                if match_id:
                    emote_id = match_id.group(1)
                ...
                if emote_id:
                    await self.start_user_dance(user_id, emote_id)
                    await self.highrise.chat(f"🎵 دنس «{emote_id}» برای @{username} اجرا شد! 🎭")
                    return

            # Dance numbers 1-269 with Chat Notification
            if msg.isdigit():
                num = int(msg)
                if 1 <= num <= len(self.emotes):
                    e = self.emotes[num - 1]
                    await self.start_user_dance(user_id, e.id)
                    await self.highrise.chat(f"🎭 دنس شماره {num} ({e.name}) برای @{username} اجرا شد! ✨")
                else:
